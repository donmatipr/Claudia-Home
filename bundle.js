  ...
  <div class="container">
    <div class="hero__content fade-in">
      <div class="hero__eyebrow" aria-hidden="true">
        \u{1F33F} Sedes en Macul y \xD1u\xF1oa, Santiago
      </div>
    ...
    <div class="for-families__grid">
      <div class="for-families__img-wrap fade-in">
        <img 
          ...
          loading="lazy"
          onerror="this.parentElement.innerHTML='&lt;div class=&quot;img-placeholder&quot;&gt;\u{1F3E1}&lt;br&gt;Espacio de la residencia&lt;/div&gt;'"
        >
      </div>
      ...
      <div class="services__grid">
        ${s.serviciosIncluidos.map(t=>`
          <div class="service-card fade-in">
            <div class="service-card__icon" aria-hidden="true">${t.icono}</div>
        ...
        <div class="contact__direct">
          ...
          >
            ...
            <div>
              ...
              <span style="font-size:0.85rem;color:var(--color-text-secondary)">${s.telefono}</span>
            </div>
          </a>
          <a 
            href="${s.telefonoHref}"
          ...
          >
            ...
            <div>
              ...
              <span style="font-size:0.85rem;color:var(--color-text-secondary)">${s.instagram}</span>
            </div>
          </a>
          <a
            href="${s.facebookUrl}"
          ...
          >
            ...
            <div>
              ...
              <span style="font-size:0.85rem;color:var(--color-text-secondary)">${s.facebook}</span>
            </div>
          </a>
        </div>
      </div>
...
El ingreso ser\xEDa *${b.toLowerCase()}*.
