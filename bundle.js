  ...
  <div class="container">
    <div class="hero__content fade-in">
      ...
      <p class="hero__subtitle">
        Residencia para personas mayores en Macul y \xD1u\xF1oa. Cuidadoras presentes de d\xEDa y de noche, cuatro comidas diarias y ocho horas semanales de kinesiolog\xEDa y terapia ocupacional.
      </p>
      <div class="hero__actions">
        <a
          ...
          rel="noopener noreferrer"
          data-track="whatsapp_click"
        >${o.whatsapp} Escribir por WhatsApp</a>
        <a
          href="#contacto"
...
<section class="trust-belt" aria-label="Datos destacados de la residencia">
  <div class="container">
    <div class="trust-belt__grid" role="list">
      ${[{icon:n.reloj,value:"24 horas",label:"con cuidadoras presentes, todos los d\xEDas del a\xF1o"},{icon:n.comida,value:"4 comidas",label:"diarias, con nutricionista una vez al mes"},{icon:n.movimiento,value:"8 horas",label:"semanales de kinesiolog\xEDa y terapia ocupacional"},{icon:n.ubicacion,value:"2 sedes",label:"en Macul y \xD1u\xF1oa, Santiago"}].map(e=>`
    ...
    <div class="for-families__grid">
      ...
      <div class="for-families__text fade-in">
        ...
        <a 
          ...
          rel="noopener noreferrer"
          data-track="whatsapp_click"
        >${o.whatsapp} Conversemos sobre tu familiar</a>
      </div>
    </div>
  </div>
      ...
      <div class="services__grid">
        ${s.serviciosIncluidos.map(t=>`
          <div class="service-card fade-in">
            <div class="service-card__icon" aria-hidden="true">${n[t.icono]||""}</div>
...
</section>`}function j(){let a=s.visitas;return a?`
        ...
        <ul class="visitas__puntos" role="list">
          ${a.puntos.map(e=>`
            <li class="visitas__punto">
              <span class="visitas__punto-icono" aria-hidden="true">${n[e.icono]||""}</span>
              ${e.texto}
            </li>`).join("")}
        </ul>
      </div>
...
</section>`}function T(){return!s.testimonios||s.testimonios.length===0?"":`
    ...
    <div class="contact__grid">
      <div class="contact__info fade-in">
        ...
        <div class="contact__direct">
          ...
          >
            <span class="contact__direct-icon contact__direct-icon--wa" aria-hidden="true">${o.whatsapp}</span>
            <div>
          ...
          >
            <span class="contact__direct-icon contact__direct-icon--phone" aria-hidden="true">${o.phone}</span>
            <div>
          ...
          >
            <span class="contact__direct-icon contact__direct-icon--ig" aria-hidden="true">${o.instagram}</span>
            <div>
          ...
          >
            <span class="contact__direct-icon contact__direct-icon--fb" aria-hidden="true">${o.facebook}</span>
            <div>
      ...
      <div class="contact-form fade-in" id="form-wrapper">
        ...
        <form id="contact-form" novalidate aria-label="Formulario de contacto">
          ...
          <button type="submit" class="btn btn-primary form-submit btn-lg" id="btn-submit" data-track="visit_form_submit">
            ${o.whatsapp} Enviar consulta por WhatsApp
          </button>
        </form>
      </div>
    </div>
    ...
    <div class="final-cta__content fade-in">
      ...
      <div class="final-cta__actions">
        ...
        <a 
          ...
          rel="noopener noreferrer"
          data-track="whatsapp_click"
        >${o.whatsapp} Hablar por WhatsApp</a>
      </div>
    </div>
  </div>
...
</div>`}function O(){let a=document.getElementById("header");if(a){let i=document.createElement("div");i.setAttribute("aria-hidden","true"),i.style.cssText="position:absolute;top:16px;height:1px;width:1px;pointer-events:none",document.body.prepend(i),new IntersectionObserver(([l])=>a.classList.toggle("is-scrolled",!l.isIntersecting),{threshold:0}).observe(i)}let e=document.getElementById("hamburger"),r=document.getElementById("main-nav");e&&r&&(e.addEventListener("click",()=>{let i=r.classList.toggle("is-open");if(e.setAttribute("aria-expanded",i.toString()),e.setAttribute("aria-label",i?"Cerrar men\xFA":"Abrir men\xFA de navegaci\xF3n"),i){let l=r.querySelector(".nav__link");l&&l.focus()}}),r.querySelectorAll(".nav__link").forEach(i=>{i.addEventListener("click",()=>{r.classList.remove("is-open"),e.setAttribute("aria-expanded","false"),e.setAttribute("aria-label","Abrir men\xFA de navegaci\xF3n")})}),document.addEventListener("keydown",i=>{i.key==="Escape"&&r.classList.contains("is-open")&&(r.classList.remove("is-open"),e.setAttribute("aria-expanded","false"),e.focus())})),document.querySelectorAll(".faq-item__btn").forEach(i=>{i.addEventListener("click",()=>{let p=i.closest(".faq-item").classList.toggle("is-open");i.setAttribute("aria-expanded",p.toString());let d=document.getElementById(i.getAttribute("aria-controls"));d&&(d.style.display=p?"block":"none")})}),document.querySelectorAll(".services__tab").forEach(i=>{i.addEventListener("click",()=>{let l=i.getAttribute("aria-controls");document.querySelectorAll(".services__tab").forEach(d=>{d.classList.remove("is-active"),d.setAttribute("aria-selected","false")}),document.querySelectorAll(".services__panel").forEach(d=>{d.classList.remove("is-active"),d.hidden=!0}),i.classList.add("is-active"),i.setAttribute("aria-selected","true");let p=document.getElementById(l);p&&(p.classList.add("is-active"),p.hidden=!1)})});let t=document.getElementById("contact-form");t&&t.addEventListener("submit",D),X(),G(),Q()}function D(a){a.preventDefault();let e=a.target,r=e.nombre.value.trim(),t=e.telefono.value.trim(),i=e.relacion.value,l=e.acepto.checked,p=!0,d=(v,k,x)=>{let b=document.getElementById(v),_=document.getElementById(k);x?(b.classList.add("has-error"),_.classList.add("is-visible"),p=!1):(b.classList.remove("has-error"),_.classList.remove("is-visible"))};d("nombre","error-nombre",!r),d("telefono","error-telefono",!t),d("relacion","error-relacion",!i);let m=document.getElementById("error-acepto"),A=document.getElementById("acepto");if(l?m.classList.remove("is-visible"):(m.classList.add("is-visible"),A.focus(),p=!1),!p){let v=e.querySelector(".has-error, input:invalid");v&&v.focus();return}let g=e.sede.value,h=e.plazo.value,$=e.nivel.value,f=e.mensaje.value.trim(),C=`Hola, vengo desde el sitio web de Casa de Reposo Claudia Lastra.
